...
public class EditorDraw
{
   ...
   public static void DrawLine(Vector2 pointA, Vector2 pointB, Color color, float width)
   {
      ...
      // Scale and rotate
      GUIUtility.ScaleAroundPivot(new Vector2((pointA - pointB).magnitude, width), new Vector2(pointA.x, pointA.y + 0.5f));
      GUIUtility.RotateAroundPivot(angle, pointA);

      GUI.DrawTexture(new Rect(pointA.x, pointA.y, 1, 1), lineTexture, ScaleMode.StretchToFill, true);
